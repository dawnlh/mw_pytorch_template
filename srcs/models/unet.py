...
@MODELS.register_module # model registry
class UNet(nn.Module):
    def __init__(self,in_nc=3, out_nc=3):
        super().__init__()

        # encoder
        self.left_conv_1 = ConvBlock(in_channels=in_nc, middle_channels=64, out_channels=64)
        ...
        self.right_conv_5 = nn.Conv2d(in_channels=64, out_channels=out_nc, kernel_size=1, stride=1, padding=0)
