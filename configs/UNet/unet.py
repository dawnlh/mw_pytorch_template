...
# runtime = dict(
#     exp_name = 'UNet',
#     status = 'realexp', # 'train' | 'test' | 'realexp'
#     gpus = [6],
#     tensorboard=True,
#     work_dir = 'work_dirs/'
# )
...
#     dataset = realexp_dataset, # test_dataset | simuexp_dataset | realexp_dataset
#     batch_size=4,
#     num_workers = 4
#     )
...
#     checkpoint = '/hhd/2/zzh/project/simple_pytorch_template/work_dirs/UNet/train/2023-11-11_15-59-36/checkpoints/model_latest.pth'
# )
